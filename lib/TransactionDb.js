...
var encodedData = require('soop').load('onixcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('onixcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('onixcore/lib/Address', {
